...
const Settings: React.FC<SettingsProps> = ({ onClose }) => {
	...
	useHotkeys(
		"ctrl+shift+u",
		() => setIsExtraSettingsOpen(!isExtraSettingsOpen),
		{
	...
	useEffect(() => {
		setTemporaryValues({
			...
			previewUrl:
				settings.signadotUrls.previewUrl || DEFAULT_SIGNADOT_PREVIEW_URL,
			dashboardUrl:
				settings.signadotUrls.dashboardUrl || DEFAULT_SIGNADOT_DASHBOARD_URL,
	...
	const handleSave = () => {
		...
		setTraceparent(
			temporaryValues.traceparentHeaderEnabled,
			temporaryValues.traceparentHeader,
		);
			...
			<div className={styles.section} data-hide-section={!isExtraSettingsOpen}>
				...
				<div className={styles.formGroup}>
					...
					<input
						...
						onChange={(e) =>
							setTemporaryValues({ ...temporaryValues, apiUrl: e.target.value })
						}
						className={styles.input}
