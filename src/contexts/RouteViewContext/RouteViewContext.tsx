...
const RouteViewContext = createContext<RouteViewContextValue>(
	{} as RouteViewContextValue,
);
...
export const RouteViewProvider: React.FC<RouteViewProviderProps> = ({
	children,
}) => {
	const [currentView, goToView] = useState<RouteView>("loading");

	return (
		<RouteViewContext.Provider value={{ currentView, goToView }}>
			{children}
